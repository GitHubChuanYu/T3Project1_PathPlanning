    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        for (int i = 0; i < sensor_fusion.size(); i++) {
          ...
          if (o_car_d > 0 && o_car_d < 4) {
            o_car_lane = 0.0;
          } else if (o_car_d > 4 && o_car_d < (4 * 2)) {
            o_car_lane = 1.0;
          } else if (o_car_d > (4 * 2) && o_car_d < (4 * 3)) {
            o_car_lane = 2.0;
          } else {
            o_car_lane = -1.0;
          }
          ...
          double o_car_s_ahead = o_car_s + (o_car_vel * 0.02 * prev_size);
        ...
        */
        ...
        if (ref_vel <= min_speed_limit) {
          ...
          // either we will reference the starting point as where the car is at or at the previous paths end point
          double ref_x = car_x;
          double ref_y = car_y;
          ...
          for (int i = 0; i < ptsx.size(); i++)
          {
              ...
              //shift car reference angle to 0 degree, and all other points to car's local reference frame
          ...
          // Define the actual waypoints that will be used for path planner
